    ...
    public RechiseledBlockType build(){
        ...
        for(ResourceLocation recipe : this.recipes)
            RechiseledChiselingRecipeProvider.addRecipeEntry(
                recipe,
                this.hasRegularVariant ? regularItemHolder::get : () -> this.customRegularVariant == null ? null : this.customRegularVariant.get().asItem(),
                this.hasConnectingVariant ? connectingItemHolder::get : () -> this.customConnectingVariant == null ? null : this.customConnectingVariant.get().asItem()
            );
