...
public class RechiseledBlocks {
    ...
    public static final RechiseledBlockType QUARTZ_BLOCK_DIAGONAL_TILES = create("quartz_block_diagonal_tiles", "Diagonal Quartz Block Tiles", () -> Blocks.QUARTZ_BLOCK).recipes(BaseChiselingRecipes.QUARTZ_BLOCK).build();
