...
public class RechiseledBlocks {
    ...
    // Cobbled deepslate
    public static final RechiseledBlockType COBBLED_DEEPSLATE_BEAMS = create("cobbled_deepslate_beams", "Cobbled Deepslate Beams", () -> Blocks.COBBLED_DEEPSLATE).recipes(BaseChiselingRecipes.COBBLED_DEEPSLATE).build();
    public static final RechiseledBlockType COBBLED_DEEPSLATE_BRICKS = create("cobbled_deepslate_bricks", "Cobbled Deepslate Bricks", () -> Blocks.COBBLED_DEEPSLATE).recipes(BaseChiselingRecipes.COBBLED_DEEPSLATE).build();
    public static final RechiseledBlockType COBBLED_DEEPSLATE_LARGE_TILES = create("cobbled_deepslate_large_tiles", "Large Cobbled Deepslate Tiles", () -> Blocks.COBBLED_DEEPSLATE).recipes(BaseChiselingRecipes.COBBLED_DEEPSLATE).build();
    public static final RechiseledBlockType COBBLED_DEEPSLATE_PAVING = create("cobbled_deepslate_paving", "Cobbled Deepslate Paving", () -> Blocks.COBBLED_DEEPSLATE).recipes(BaseChiselingRecipes.COBBLED_DEEPSLATE).build();
    public static final RechiseledBlockType COBBLED_DEEPSLATE_PULVERIZED = create("cobbled_deepslate_pulverized", "Pulverized Cobbled Deepslate", () -> Blocks.COBBLED_DEEPSLATE).recipes(BaseChiselingRecipes.COBBLED_DEEPSLATE).build();
    public static final RechiseledBlockType COBBLED_DEEPSLATE_ROTATED_BRICKS = create("cobbled_deepslate_rotated_bricks", "Rotated Cobbled Deepslate Bricks", () -> Blocks.COBBLED_DEEPSLATE).recipes(BaseChiselingRecipes.COBBLED_DEEPSLATE).build();
    public static final RechiseledBlockType COBBLED_DEEPSLATE_SMALL_TILES = create("cobbled_deepslate_small_tiles", "Small Cobbled Deepslate Tiles", () -> Blocks.COBBLED_DEEPSLATE).recipes(BaseChiselingRecipes.COBBLED_DEEPSLATE).build();
    public static final RechiseledBlockType COBBLED_DEEPSLATE_SQUARES = create("cobbled_deepslate_squares", "Cobbled Deepslate Squares", () -> Blocks.COBBLED_DEEPSLATE).recipes(BaseChiselingRecipes.COBBLED_DEEPSLATE).build();
    public static final RechiseledBlockType COBBLED_DEEPSLATE_STRIPES = create("cobbled_deepslate_stripes", "Cobbled Deepslate Stripes", () -> Blocks.COBBLED_DEEPSLATE).recipes(BaseChiselingRecipes.COBBLED_DEEPSLATE).build();
    public static final RechiseledBlockType COBBLED_DEEPSLATE_TILES = create("cobbled_deepslate_tiles", "Cobbled Deepslate Tiles", () -> Blocks.COBBLED_DEEPSLATE).recipes(BaseChiselingRecipes.COBBLED_DEEPSLATE).build();
    public static final RechiseledBlockType COBBLED_DEEPSLATE_WORN_STRIPES = create("cobbled_deepslate_worn_stripes", "Weathered Cobbled Deepslate Stripes", () -> Blocks.COBBLED_DEEPSLATE).recipes(BaseChiselingRecipes.COBBLED_DEEPSLATE).build();
    // Cobblestone
    ...
    // Mangrove planks
    public static final RechiseledBlockType MANGROVE_PLANKS_BEAMS = create("mangrove_planks_beams", "Mangrove Plank Beams", () -> Blocks.MANGROVE_PLANKS).recipes(BaseChiselingRecipes.MANGROVE_PLANKS).build();
    public static final RechiseledBlockType MANGROVE_PLANKS_BRICKS = create("mangrove_planks_bricks", "Mangrove Plank Bricks", () -> Blocks.MANGROVE_PLANKS).recipes(BaseChiselingRecipes.MANGROVE_PLANKS).build();
    public static final RechiseledBlockType MANGROVE_PLANKS_CRATE = create("mangrove_planks_crate", "Mangrove Planks Crate", () -> Blocks.MANGROVE_PLANKS).recipes(BaseChiselingRecipes.MANGROVE_PLANKS).build();
    public static final RechiseledBlockType MANGROVE_PLANKS_DIAGONAL_STRIPES = create("mangrove_planks_diagonal_stripes", "Diagonal Mangrove Plank Stripes", () -> Blocks.MANGROVE_PLANKS).recipes(BaseChiselingRecipes.MANGROVE_PLANKS).build();
    public static final RechiseledBlockType MANGROVE_PLANKS_DIAGONAL_TILES = create("mangrove_planks_diagonal_tiles", "Diagonal Mangrove Plank Tiles", () -> Blocks.MANGROVE_PLANKS).recipes(BaseChiselingRecipes.MANGROVE_PLANKS).build();
    public static final RechiseledBlockType MANGROVE_PLANKS_DOTTED = create("mangrove_planks_dotted", "Dotted Mangrove Planks", () -> Blocks.MANGROVE_PLANKS).recipes(BaseChiselingRecipes.MANGROVE_PLANKS).build();
    public static final RechiseledBlockType MANGROVE_PLANKS_FLOORING = create("mangrove_planks_flooring", "Mangrove Plank Flooring", () -> Blocks.MANGROVE_PLANKS).recipes(BaseChiselingRecipes.MANGROVE_PLANKS).build();
    public static final RechiseledBlockType MANGROVE_PLANKS_LARGE_TILES = create("mangrove_planks_large_tiles", "Large Mangrove Plank Tiles", () -> Blocks.MANGROVE_PLANKS).recipes(BaseChiselingRecipes.MANGROVE_PLANKS).build();
    public static final RechiseledBlockType MANGROVE_PLANKS_PATTERN = create("mangrove_planks_pattern", "Mangrove Plank Pattern", () -> Blocks.MANGROVE_PLANKS).recipes(BaseChiselingRecipes.MANGROVE_PLANKS).build();
    public static final RechiseledBlockType MANGROVE_PLANKS_SMALL_BRICKS = create("mangrove_planks_small_bricks", "Small Mangrove Plank Bricks", () -> Blocks.MANGROVE_PLANKS).recipes(BaseChiselingRecipes.MANGROVE_PLANKS).build();
    public static final RechiseledBlockType MANGROVE_PLANKS_SMALL_TILES = create("mangrove_planks_small_tiles", "Small Mangrove Plank Tiles", () -> Blocks.MANGROVE_PLANKS).recipes(BaseChiselingRecipes.MANGROVE_PLANKS).build();
    public static final RechiseledBlockType MANGROVE_PLANKS_SQUARES = create("mangrove_planks_squares", "Mangrove Plank Squares", () -> Blocks.MANGROVE_PLANKS).recipes(BaseChiselingRecipes.MANGROVE_PLANKS).build();
    public static final RechiseledBlockType MANGROVE_PLANKS_TILES = create("mangrove_planks_tiles", "Mangrove Plank Tiles", () -> Blocks.MANGROVE_PLANKS).recipes(BaseChiselingRecipes.MANGROVE_PLANKS).build();
    public static final RechiseledBlockType MANGROVE_PLANKS_WAVY = create("mangrove_planks_wavy", "Wavy Mangrove Planks", () -> Blocks.MANGROVE_PLANKS).recipes(BaseChiselingRecipes.MANGROVE_PLANKS).build();
    public static final RechiseledBlockType MANGROVE_PLANKS_WOVEN = create("mangrove_planks_woven", "Woven Mangrove Planks", () -> Blocks.MANGROVE_PLANKS).recipes(BaseChiselingRecipes.MANGROVE_PLANKS).build();
    // Mossy cobblestone
