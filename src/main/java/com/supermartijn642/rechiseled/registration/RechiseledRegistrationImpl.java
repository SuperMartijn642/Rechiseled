...
public class RechiseledRegistrationImpl implements RechiseledRegistration {
    ...
    private final List<Pair<Identifier,Consumer<ChiselingRecipeProvider.ChiselingEntryBuilder>>> chiselingEntries = new ArrayList<>();
    ...
    @Override
    public void chiselingEntry(Identifier recipe, Supplier<ItemLike> regularBlock, Supplier<ItemLike> regularStairs, Supplier<ItemLike> regularSlab, Supplier<ItemLike> connectingBlock, Supplier<ItemLike> connectingStairs, Supplier<ItemLike> connectingSlab){
        if(finalized)
    ...
    @Override
    public void chiselingEntry(Identifier recipe, Supplier<ItemLike> regularBlock, Supplier<ItemLike> connectingBlock){
    ...
    public void registerDataProviders(){
        ...
        handler.addProvider(generator -> new RegistrationChiselingRecipeProvider(this, generator));
    ...
    public List<Pair<Identifier,Consumer<ChiselingRecipeProvider.ChiselingEntryBuilder>>> getChiselingEntries(){
