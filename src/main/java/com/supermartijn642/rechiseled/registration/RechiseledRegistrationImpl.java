...
public class RechiseledRegistrationImpl implements RechiseledRegistration {
    ...
    private final List<Triple<ResourceLocation,Pair<Supplier<Item>,Integer>,Pair<Supplier<Item>,Integer>>> chiselingEntries = new ArrayList<>();
    ...
    @Override
    public synchronized void chiselingEntry(ResourceLocation recipe, Supplier<Item> regularItem, int regularData, Supplier<Item> connectingItem, int connectingData){
        if(finalized)
        ...
        this.chiselingEntries.add(Triple.of(recipe, Pair.of(regularItem, regularData), Pair.of(connectingItem, connectingData)));
    }
    ...
    public List<Triple<ResourceLocation,Pair<Supplier<Item>,Integer>,Pair<Supplier<Item>,Integer>>> getChiselingEntries(){
