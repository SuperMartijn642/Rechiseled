...
public class RechiseledBlockBuilderImpl extends RechiseledCommonBlockBuilderImpl<RechiseledBlockBuilder> implements RechiseledBlockBuilder {
    ...
    private final Set<Identifier> stairsSlabsBlockTags = new HashSet<>(), stairsSlabsItemTags = new HashSet<>();
    ...
    @Override
    public RechiseledBlockBuilder recipe(Identifier location){
        this.checkMutable();
    ...
    @Override
    public RechiseledBlockBuilder blockTag(Identifier identifier, boolean includeStairsAndSlabs){
        this.checkMutable();
    ...
    @Override
    public RechiseledBlockBuilder itemTag(Identifier identifier, boolean includeStairsAndSlabs){
        this.checkMutable();
