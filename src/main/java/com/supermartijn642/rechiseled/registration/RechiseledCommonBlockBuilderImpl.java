...
public abstract class RechiseledCommonBlockBuilderImpl<T extends RechiseledCommonBlockBuilder<?>> implements RechiseledCommonBlockBuilder<T> {
    ...
    void createBlocks(BlockSpecification specification){
        ...
        ResourceLocation blockIdentifier = ResourceLocation.fromNamespaceAndPath(this.registration.getModid(), this.identifier);
    ...
    public T blockTag(String namespace, String identifier){
        this.checkMutable();
        this.blockTags.add(ResourceLocation.fromNamespaceAndPath(namespace, identifier));
        return this.self();
    }
    ...
    public T itemTag(String namespace, String identifier){
        this.checkMutable();
        this.itemTags.add(ResourceLocation.fromNamespaceAndPath(namespace, identifier));
        return this.self();
    }
