...
public class REIScrollableSlotsWidget extends WidgetWithBounds implements DraggableStackProviderWidget {
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTicks){
        ...
        // Render scrollbar
        ScreenUtils.drawTexture(SCROLLBAR_BACKGROUND, pose, BOX_WIDTH + 2, 0, SCROLLBAR_WIDTH, HEIGHT);
        // Render cursor
        if(this.scrollable){
            ...
            ScreenUtils.drawTexture(SCROLLER, pose, BOX_WIDTH + 3, y, 12, SCROLLER_HEIGHT, 0, highlighted ? 1 / 3f : 0, 1, 1 / 3f);
        }else
            ScreenUtils.drawTexture(SCROLLER, pose, BOX_WIDTH + 3, 1, SCROLLBAR_WIDTH - 2, SCROLLER_HEIGHT, 0, 2 / 3f, 1, 1 / 3f);
