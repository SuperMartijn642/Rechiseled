...
public class JEIFieldAccess {
    ...
    private static Field recipeLayoutRecipeWrapper;

    public static Object getRecipeLayoutRecipeWrapper(RecipeLayout recipeLayout){
        if(recipeLayoutRecipeWrapper == null)
            recipeLayoutRecipeWrapper = getField(RecipeLayout.class, "recipeWrapper");
        return getValue(recipeLayoutRecipeWrapper, recipeLayout);
    }
