...
public class JEIFieldAccess {
    ...
    private static Field recipeLayoutRecipe;

    public static Object getRecipeLayoutRecipe(RecipeLayout recipeLayout){
        if(recipeLayoutRecipe == null)
            recipeLayoutRecipe = getField(RecipeLayout.class, "recipe");
        return getValue(recipeLayoutRecipe, recipeLayout);
    }
