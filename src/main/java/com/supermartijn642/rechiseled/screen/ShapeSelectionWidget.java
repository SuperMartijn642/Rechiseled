...
public class ShapeSelectionWidget extends AbstractButtonWidget {
    ...
    public static final ResourceLocation BLOCK_ICON = Rechiseled.identifier("screen/icon_1x1");
    public static final ResourceLocation STAIRS_ICON = Rechiseled.identifier("screen/icon_stairs");
    public static final ResourceLocation SLAB_ICON = Rechiseled.identifier("screen/icon_slab");
