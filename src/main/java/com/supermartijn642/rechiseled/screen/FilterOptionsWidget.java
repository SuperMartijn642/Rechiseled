...
public class FilterOptionsWidget extends BaseWidget {
    ...
    public static final Identifier BUTTONS = Rechiseled.identifier("screen/filter_buttons");
    public static final Identifier MARKER = Rechiseled.identifier("screen/filter_marker");
    public static final Identifier CHECKMARK = Rechiseled.identifier("screen/checkmark");
