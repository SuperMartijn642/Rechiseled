...
public class ToggleRotationButton extends AbstractButtonWidget {
    ...
    public void render(WidgetRenderContext context, int mouseX, int mouseY){
        ScreenUtils.drawTexture(TEXTURE, context.poseStack(), this.x, this.y, this.width, this.height, this.rotating.getAsBoolean() ? 0 : 0.5f, this.isFocused() && this.hasItem.getAsBoolean() ? 0.5f : 0, 0.5f, 0.5f);
