...
public class PreviewModeButtonWidget extends AbstractButtonWidget {
    ...
    public void render(WidgetRenderContext context, int mouseX, int mouseY){
        ...
        ScreenUtils.drawTexture(GREY_BUTTONS, context.poseStack(), this.x, this.y, this.width, this.height, 0, (!this.isClickable() ? 1 : this.isFocused() ? 2 : 0) / 3f, 1, 1 / 3f);
        ScreenUtils.drawTexture(this.mode.icon(selected), context.poseStack(), this.x + 1, this.y + 2, this.width - 2, this.height - 4);
    }
}
