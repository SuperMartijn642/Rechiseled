...
public class ScreenItemRenderer {
    ...
    public static void drawItem(Item item, double x, double y, double scale, float yaw, float pitch, boolean flatShading){
        ...
        if(model != null)
            ClientUtils.getItemRenderer().render(item.getDefaultInstance(), ItemTransforms.TransformType.GUI, false, POSE_STACK, bufferSource, 15728880, OverlayTexture.NO_OVERLAY, model);
