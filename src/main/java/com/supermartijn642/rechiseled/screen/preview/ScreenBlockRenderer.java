...
public class ScreenBlockRenderer {
    ...
    private static void updateBlockState(BlockAndTintGetter level, BlockPos pos, BlockState blockState, BlockModelRenderState blockRenderState){
        ...
        QuadEmitter emitter = blockRenderState.setupMesh(IDENTITY_MATRIX, model.hasMaterialFlag(level, pos, blockState, RANDOM_SOURCE, BakedQuad.FLAG_TRANSLUCENT));
        RANDOM_SOURCE.setSeed(seed);
        model.emitQuads(emitter, level, pos, blockState, RANDOM_SOURCE, _ -> false);
