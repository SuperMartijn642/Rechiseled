...
public class ScreenBlockRenderer {
    ...
    private static void renderBlock(BlockAndTintGetter level, BlockPos pos, BlockState state, PoseStack poseStack, MultiBufferSource bufferSource){
        ...
        RANDOM.setSeed(seed);
        ClientUtils.getBlockRenderer().getModelRenderer().tesselateBlock(level, model, state, pos, poseStack, bufferSource.getBuffer(renderType), true, RANDOM, seed, OverlayTexture.NO_OVERLAY);
