...
public class RechiseledBlocks {
    ...
    // Copper block
    public static final RechiseledBlockType COPPER_BLOCK_BARS = create("copper_block_bars", "Copper Bars Block").properties(BlockProperties.create(Material.METAL, MaterialColor.COLOR_ORANGE).sound(SoundType.COPPER).requiresCorrectTool().destroyTime(3).explosionResistance(6)).blockTag("minecraft", "mineable/pickaxe").blockTag("minecraft", "needs_stone_tool").recipe(BaseChiselingRecipes.COPPER_BLOCK).build();
    public static final RechiseledBlockType COPPER_BLOCK_CIRCLES = create("copper_block_circles", "Copper Block Circles").properties(BlockProperties.create(Material.METAL, MaterialColor.COLOR_ORANGE).sound(SoundType.COPPER).requiresCorrectTool().destroyTime(3).explosionResistance(6)).blockTag("minecraft", "mineable/pickaxe").blockTag("minecraft", "needs_stone_tool").recipe(BaseChiselingRecipes.COPPER_BLOCK).build();
    public static final RechiseledBlockType COPPER_BLOCK_CONE = create("copper_block_cone", "Copper Cone Block").properties(BlockProperties.create(Material.METAL, MaterialColor.COLOR_ORANGE).sound(SoundType.COPPER).requiresCorrectTool().destroyTime(3).explosionResistance(6)).blockTag("minecraft", "mineable/pickaxe").blockTag("minecraft", "needs_stone_tool").noConnectingVariant().recipe(BaseChiselingRecipes.COPPER_BLOCK).build();
    public static final RechiseledBlockType COPPER_BLOCK_GEARS = create("copper_block_gears", "Copper Block Gears").properties(BlockProperties.create(Material.METAL, MaterialColor.COLOR_ORANGE).sound(SoundType.COPPER).requiresCorrectTool().destroyTime(3).explosionResistance(6)).blockTag("minecraft", "mineable/pickaxe").blockTag("minecraft", "needs_stone_tool").recipe(BaseChiselingRecipes.COPPER_BLOCK).build();
    public static final RechiseledBlockType COPPER_BLOCK_LINES = create("copper_block_lines", "Copper Block Lines").properties(BlockProperties.create(Material.METAL, MaterialColor.COLOR_ORANGE).sound(SoundType.COPPER).requiresCorrectTool().destroyTime(3).explosionResistance(6)).blockTag("minecraft", "mineable/pickaxe").blockTag("minecraft", "needs_stone_tool").recipe(BaseChiselingRecipes.COPPER_BLOCK).build();
    public static final RechiseledBlockType COPPER_BLOCK_PATTERN = create("copper_block_pattern", "Copper Block Pattern").properties(BlockProperties.create(Material.METAL, MaterialColor.COLOR_ORANGE).sound(SoundType.COPPER).requiresCorrectTool().destroyTime(3).explosionResistance(6)).blockTag("minecraft", "mineable/pickaxe").blockTag("minecraft", "needs_stone_tool").recipe(BaseChiselingRecipes.COPPER_BLOCK).build();
    public static final RechiseledBlockType COPPER_BLOCK_PILLAR = create("copper_block_pillar", "Copper Block Pillar").properties(BlockProperties.create(Material.METAL, MaterialColor.COLOR_ORANGE).sound(SoundType.COPPER).requiresCorrectTool().destroyTime(3).explosionResistance(6)).blockTag("minecraft", "mineable/pickaxe").blockTag("minecraft", "needs_stone_tool").specification(BlockSpecification.PILLAR).recipe(BaseChiselingRecipes.COPPER_BLOCK).build();
    public static final RechiseledBlockType COPPER_BLOCK_POLISHED = create("copper_block_polished", "Polished Block of Copper").properties(BlockProperties.create(Material.METAL, MaterialColor.COLOR_ORANGE).sound(SoundType.COPPER).requiresCorrectTool().destroyTime(3).explosionResistance(6)).blockTag("minecraft", "mineable/pickaxe").blockTag("minecraft", "needs_stone_tool").recipe(BaseChiselingRecipes.COPPER_BLOCK).build();
    public static final RechiseledBlockType COPPER_BLOCK_SHAFTS = create("copper_block_shafts", "Copper Shafts Block").properties(BlockProperties.create(Material.METAL, MaterialColor.COLOR_ORANGE).sound(SoundType.COPPER).requiresCorrectTool().destroyTime(3).explosionResistance(6)).blockTag("minecraft", "mineable/pickaxe").blockTag("minecraft", "needs_stone_tool").recipe(BaseChiselingRecipes.COPPER_BLOCK).build();
    public static final RechiseledBlockType COPPER_BLOCK_SMALL_BRICKS = create("copper_block_small_bricks", "Small Copper Bricks").properties(BlockProperties.create(Material.METAL, MaterialColor.COLOR_ORANGE).sound(SoundType.COPPER).requiresCorrectTool().destroyTime(3).explosionResistance(6)).blockTag("minecraft", "mineable/pickaxe").blockTag("minecraft", "needs_stone_tool").recipe(BaseChiselingRecipes.COPPER_BLOCK).build();
    public static final RechiseledBlockType COPPER_BLOCK_SMOOTH = create("copper_block_smooth", "Smooth Block of Copper").properties(BlockProperties.create(Material.METAL, MaterialColor.COLOR_ORANGE).sound(SoundType.COPPER).requiresCorrectTool().destroyTime(3).explosionResistance(6)).blockTag("minecraft", "mineable/pickaxe").blockTag("minecraft", "needs_stone_tool").noConnectingVariant().recipe(BaseChiselingRecipes.COPPER_BLOCK).build();
    // Crimson planks
