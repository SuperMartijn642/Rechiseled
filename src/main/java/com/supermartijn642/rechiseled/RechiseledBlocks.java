...
public class RechiseledBlocks {
    ...
    // Copper block
    public static final RechiseledBlockType COPPER_BLOCK_BARS = create("copper_block_bars", "Copper Bars Block").properties(BlockProperties.create().mapColor(MapColor.COLOR_ORANGE).sound(SoundType.COPPER).requiresCorrectTool().destroyTime(3).explosionResistance(6)).blockTag("minecraft", "mineable/pickaxe").blockTag("minecraft", "needs_stone_tool").recipe(BaseChiselingRecipes.COPPER_BLOCK).build();
    public static final RechiseledBlockType COPPER_BLOCK_CIRCLES = create("copper_block_circles", "Copper Block Circles").properties(BlockProperties.create().mapColor(MapColor.COLOR_ORANGE).sound(SoundType.COPPER).requiresCorrectTool().destroyTime(3).explosionResistance(6)).blockTag("minecraft", "mineable/pickaxe").blockTag("minecraft", "needs_stone_tool").recipe(BaseChiselingRecipes.COPPER_BLOCK).build();
    ...
    public static final RechiseledBlockType COPPER_BLOCK_LINES = create("copper_block_lines", "Copper Block Lines").properties(BlockProperties.create().mapColor(MapColor.COLOR_ORANGE).sound(SoundType.COPPER).requiresCorrectTool().destroyTime(3).explosionResistance(6)).blockTag("minecraft", "mineable/pickaxe").blockTag("minecraft", "needs_stone_tool").recipe(BaseChiselingRecipes.COPPER_BLOCK).build();
    public static final RechiseledBlockType COPPER_BLOCK_PATTERN = create("copper_block_pattern", "Copper Block Pattern").properties(BlockProperties.create().mapColor(MapColor.COLOR_ORANGE).sound(SoundType.COPPER).requiresCorrectTool().destroyTime(3).explosionResistance(6)).blockTag("minecraft", "mineable/pickaxe").blockTag("minecraft", "needs_stone_tool").recipe(BaseChiselingRecipes.COPPER_BLOCK).build();
