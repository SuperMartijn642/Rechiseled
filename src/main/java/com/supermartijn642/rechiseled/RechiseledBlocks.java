...
public class RechiseledBlocks {
    ...
    // Red nether bricks
    public static final RechiseledBlockType RED_NETHER_BRICKS_BEAMS = create("red_nether_bricks_beams", "Red Nether Brick Beams", () -> Blocks.RED_NETHER_BRICKS).recipe(BaseChiselingRecipes.RED_NETHER_BRICKS).build();
    public static final RechiseledBlockType RED_NETHER_BRICKS_BRICK_PATTERN = create("red_nether_bricks_brick_pattern", "Red Nether Brick Pattern", () -> Blocks.RED_NETHER_BRICKS).recipe(BaseChiselingRecipes.RED_NETHER_BRICKS).build();
    public static final RechiseledBlockType RED_NETHER_BRICKS_BRICK_PAVING = create("red_nether_bricks_brick_paving", "Red Nether Brick Paving", () -> Blocks.RED_NETHER_BRICKS).recipe(BaseChiselingRecipes.RED_NETHER_BRICKS).build();
    public static final RechiseledBlockType RED_NETHER_BRICKS_CHISELED_SQUARES = create("red_nether_bricks_chiseled_squares", "Chiseled Red Nether Brick Squares", () -> Blocks.RED_NETHER_BRICKS).recipe(BaseChiselingRecipes.RED_NETHER_BRICKS).build();
    public static final RechiseledBlockType RED_NETHER_BRICKS_DIAGONAL_BRICKS = create("red_nether_bricks_diagonal_bricks", "Diagonal Red Nether Bricks", () -> Blocks.RED_NETHER_BRICKS).recipe(BaseChiselingRecipes.RED_NETHER_BRICKS).build();
    ...
    public static final RechiseledBlockType RED_NETHER_BRICKS_ROTATED_BRICKS = create("red_nether_bricks_rotated_bricks", "Rotated Red Nether Bricks", () -> Blocks.RED_NETHER_BRICKS).recipe(BaseChiselingRecipes.RED_NETHER_BRICKS).build();
    ...
    public static final RechiseledBlockType RED_NETHER_BRICKS_SMOOTH = create("red_nether_bricks_smooth", "Red Nether Bricks Smooth", () -> Blocks.RED_NETHER_BRICKS).recipe(BaseChiselingRecipes.RED_NETHER_BRICKS).build();
    public static final RechiseledBlockType RED_NETHER_BRICKS_SQUARES = create("red_nether_bricks_squares", "Red Nether Brick Squares", () -> Blocks.RED_NETHER_BRICKS).recipe(BaseChiselingRecipes.RED_NETHER_BRICKS).build();
