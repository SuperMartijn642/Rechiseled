...
public class ChiselingEntryImpl implements ChiselingEntry {
    ...
    public static ChiselingEntry fromJson(JsonElement element){
        ...
        if(json.has("item") || json.has("connecting_item")){
            ItemWithMeta item = readItem(json, "item");
            ItemWithMeta connectingItem = readItem(json, "connecting_item");
        ...
        ItemWithMeta regularBlock = readItem(json, "block");
        ItemWithMeta regularStairs = readItem(json, "stairs");
        ItemWithMeta regularSlab = readItem(json, "slab");
        ItemWithMeta connectingBlock = readItem(json, "connecting_block");
        ItemWithMeta connectingStairs = readItem(json, "connecting_stairs");
        ItemWithMeta connectingSlab = readItem(json, "connecting_slab");
    ...
    private static ItemWithMeta readItem(JsonObject json, String key){
        if(!json.has(key))
            return null;
