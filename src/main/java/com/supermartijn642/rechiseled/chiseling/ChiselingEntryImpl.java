...
public class ChiselingEntryImpl implements ChiselingEntry {
    ...
    public ChiselingEntryImpl(ResourceLocation owner, ResourceLocation recipe,
        ...
        if(duplicate != null)
            throw new IllegalArgumentException("Duplicate item '" + Registry.ITEM.getKey(duplicate) + "'!");
        this.owner = owner;
        this.recipe = recipe;
    ...
    public static ChiselingEntry fromJson(JsonElement element){
        ...
        if(json.has("item") || json.has("connecting_item")){
            ...
            if(duplicate != null)
                throw new JsonParseException("Duplicate item '" + Registry.ITEM.getKey(duplicate) + "' within one entry!");
            return new ChiselingEntryImpl(
                null, null,
                item, null, null,
