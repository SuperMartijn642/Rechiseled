...
public class ChiselingEntryBuilderImpl implements ChiselingEntryBuilder {
    ...
    @Override
    public ChiselingEntryBuilder regularItem(ChiselingBlockShape shape, ItemWithMeta item, float worth){
        if(item == null)
            throw new IllegalArgumentException("Item must not be null!");
        if(worth <= 0)
            throw new IllegalArgumentException("Worth must be greater than zero!");

        this.items.put(shape, ItemWithWorthImpl.of(item, worth));
        return this;
    }
    ...
    @Override
    public ChiselingEntryBuilder connectingItem(ChiselingBlockShape shape, ItemWithMeta item, float worth){
        if(item == null)
            throw new IllegalArgumentException("Item must not be null!");
        if(worth <= 0)
            throw new IllegalArgumentException("Worth must be greater than zero!");

        this.connectingItems.put(shape, ItemWithWorthImpl.of(item, worth));
        return this;
    }
    ...
    @Override
    public ChiselingEntryBuilder regularBlock(ItemWithMeta item, float worth){
    ...
    @Override
    public ChiselingEntryBuilder regularStairs(ItemWithMeta item, float worth){
    ...
    @Override
    public ChiselingEntryBuilder regularSlab(ItemWithMeta item, float worth){
    ...
    @Override
    public ChiselingEntryBuilder connectingBlock(ItemWithMeta item, float worth){
    ...
    @Override
    public ChiselingEntryBuilder connectingStairs(ItemWithMeta item, float worth){
    ...
    @Override
    public ChiselingEntryBuilder connectingSlab(ItemWithMeta item, float worth){
