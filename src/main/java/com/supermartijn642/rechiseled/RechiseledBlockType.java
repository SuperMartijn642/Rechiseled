...
public enum RechiseledBlockType {
    ...
    COBBLED_DEEPSLATE_BEAMS("Cobbled Deepslate Beams", () -> Blocks.COBBLED_DEEPSLATE, NON_CONNECTING, CONNECTING, COBBLED_DEEPSLATE),
    COBBLED_DEEPSLATE_BRICKS("Cobbled Deepslate Bricks", () -> Blocks.COBBLED_DEEPSLATE, NON_CONNECTING, CONNECTING, COBBLED_DEEPSLATE),
    COBBLED_DEEPSLATE_LARGE_TILES("Large Cobbled Deepslate Tiles", () -> Blocks.COBBLED_DEEPSLATE, NON_CONNECTING, CONNECTING, COBBLED_DEEPSLATE),
    COBBLED_DEEPSLATE_PAVING("Cobbled Deepslate Paving", () -> Blocks.COBBLED_DEEPSLATE, NON_CONNECTING, CONNECTING, COBBLED_DEEPSLATE),
    COBBLED_DEEPSLATE_PULVERIZED("Pulverized Cobbled Deepslate", () -> Blocks.COBBLED_DEEPSLATE, NON_CONNECTING, CONNECTING, COBBLED_DEEPSLATE),
    COBBLED_DEEPSLATE_ROTATED_BRICKS("Rotated Cobbled Deepslate Bricks", () -> Blocks.COBBLED_DEEPSLATE, NON_CONNECTING, CONNECTING, COBBLED_DEEPSLATE),
    COBBLED_DEEPSLATE_SMALL_TILES("Small Cobbled Deepslate Tiles", () -> Blocks.COBBLED_DEEPSLATE, NON_CONNECTING, CONNECTING, COBBLED_DEEPSLATE),
    COBBLED_DEEPSLATE_SQUARES("Cobbled Deepslate Squares", () -> Blocks.COBBLED_DEEPSLATE, NON_CONNECTING, CONNECTING, COBBLED_DEEPSLATE),
    COBBLED_DEEPSLATE_STRIPES("Cobbled Deepslate Stripes", () -> Blocks.COBBLED_DEEPSLATE, NON_CONNECTING, CONNECTING, COBBLED_DEEPSLATE),
    COBBLED_DEEPSLATE_TILES("Cobbled Deepslate Tiles", () -> Blocks.COBBLED_DEEPSLATE, NON_CONNECTING, CONNECTING, COBBLED_DEEPSLATE),
    COBBLED_DEEPSLATE_WORN_STRIPES("Weathered Cobbled Deepslate Stripes", () -> Blocks.COBBLED_DEEPSLATE, NON_CONNECTING, CONNECTING, COBBLED_DEEPSLATE),
