...
public enum RechiseledBlockType {
    ...
    DARK_PRISMARINE_BEAMS("Dark Prismarine Beams", () -> Blocks.DARK_PRISMARINE, false, DARK_PRISMARINE),
    DARK_PRISMARINE_BRICKS("Dark Prismarine Bricks", () -> Blocks.DARK_PRISMARINE, false, DARK_PRISMARINE),
    DARK_PRISMARINE_DOTTED("Dotted Dark Prismarine", () -> Blocks.DARK_PRISMARINE, false, DARK_PRISMARINE),
    DARK_PRISMARINE_FABRIC("Dark Prismarine Fabric", () -> Blocks.DARK_PRISMARINE, false, DARK_PRISMARINE),
    DARK_PRISMARINE_LARGE_TILES("Large Dark Prismarine Tiles", () -> Blocks.DARK_PRISMARINE, false, DARK_PRISMARINE),
    DARK_PRISMARINE_ROWS("Dark Prismarine Rows", () -> Blocks.DARK_PRISMARINE, false, DARK_PRISMARINE),
    DARK_PRISMARINE_SQUARES("Dark Prismarine Squares", () -> Blocks.DARK_PRISMARINE, false, DARK_PRISMARINE),
    DARK_PRISMARINE_TILES("Dark Prismarine Tiles", () -> Blocks.DARK_PRISMARINE, false, DARK_PRISMARINE),
    DARK_PRISMARINE_WAVY("Wavy Dark Prismarine", () -> Blocks.DARK_PRISMARINE, false, DARK_PRISMARINE),
    DARK_PRISMARINE_WOVEN("Woven Dark Prismarine", () -> Blocks.DARK_PRISMARINE, false, DARK_PRISMARINE),
    ...
    NETHER_BRICKS_BEAMS("Nether Brick Beams", () -> Blocks.NETHER_BRICKS, false, NETHER_BRICKS),
    NETHER_BRICKS_CHISELED_SQUARES("Chiseled Nether Brick Squares", () -> Blocks.NETHER_BRICKS, false, NETHER_BRICKS),
    NETHER_BRICKS_DIAGONAL_BRICKS("Diagonal Nether Bricks", () -> Blocks.NETHER_BRICKS, false, NETHER_BRICKS),
    ...
    NETHER_BRICKS_ROTATED_BRICKS("Rotated Nether Bricks", () -> Blocks.NETHER_BRICKS, false, NETHER_BRICKS),
    NETHER_BRICKS_SMALL_TILES("Small Nether Brick Tiles", () -> Blocks.NETHER_BRICKS, false, NETHER_BRICKS),
    NETHER_BRICKS_SMOOTH("Nether Bricks Smooth", () -> Blocks.NETHER_BRICKS, false, NETHER_BRICKS),
    NETHER_BRICKS_SQUARES("Nether Brick Squares", () -> Blocks.NETHER_BRICKS, false, NETHER_BRICKS),
    ...
    PRISMARINE_BRICKS_BEAMS("Prismarine Brick Beams", () -> Blocks.PRISMARINE_BRICKS, false, PRISMARINE_BRICKS),
    PRISMARINE_BRICKS_BRICKS("Prismarine Bricks", () -> Blocks.PRISMARINE_BRICKS, false, PRISMARINE_BRICKS),
    PRISMARINE_BRICKS_DOTTED("Dotted Prismarine Bricks", () -> Blocks.PRISMARINE_BRICKS, false, PRISMARINE_BRICKS),
    PRISMARINE_BRICKS_CHISELED_CIRCLES("Chiseled Prismarine Brick Circles", () -> Blocks.PRISMARINE_BRICKS, false, PRISMARINE_BRICKS),
    PRISMARINE_BRICKS_CHISELED_SQUARES("Chiseled Prismarine Brick Squares", () -> Blocks.PRISMARINE_BRICKS, false, PRISMARINE_BRICKS),
    PRISMARINE_BRICKS_DIAGONAL_BRICKS("Diagonal Prismarine Bricks", () -> Blocks.PRISMARINE_BRICKS, false, PRISMARINE_BRICKS),
    PRISMARINE_BRICKS_DIAGONAL_TILES("Diagonal Prismarine Brick Tiles", () -> Blocks.PRISMARINE_BRICKS, false, PRISMARINE_BRICKS),
    PRISMARINE_BRICKS_PILLARS("Prismarine Brick Pillars", () -> Blocks.PRISMARINE_BRICKS, false, PRISMARINE_BRICKS),
    PRISMARINE_BRICKS_POLISHED("Polished Prismarine Bricks", () -> Blocks.PRISMARINE_BRICKS, false, PRISMARINE_BRICKS),
    PRISMARINE_BRICKS_ROWS("Prismarine Brick Rows", () -> Blocks.PRISMARINE_BRICKS, false, PRISMARINE_BRICKS),
    PRISMARINE_BRICKS_SMALL_TILES("Small Prismarine Brick Tiles", () -> Blocks.PRISMARINE_BRICKS, false, PRISMARINE_BRICKS),
    PRISMARINE_BRICKS_SQUARES("Prismarine Brick Squares", () -> Blocks.PRISMARINE_BRICKS, false, PRISMARINE_BRICKS),
    PRISMARINE_BRICKS_TILES("Prismarine Brick Tiles", () -> Blocks.PRISMARINE_BRICKS, false, PRISMARINE_BRICKS),
    PRISMARINE_BRICKS_WAVY("Wavy Prismarine Bricks", () -> Blocks.PRISMARINE_BRICKS, false, PRISMARINE_BRICKS),
    PRISMARINE_BRICKS_WOVEN("Woven Prismarine Bricks", () -> Blocks.PRISMARINE_BRICKS, false, PRISMARINE_BRICKS),
    RED_NETHER_BRICKS_BEAMS("Nether Brick Beams", () -> Blocks.RED_NETHER_BRICKS, false, RED_NETHER_BRICKS),
    RED_NETHER_BRICKS_CHISELED_SQUARES("Chiseled Nether Brick Squares", () -> Blocks.RED_NETHER_BRICKS, false, RED_NETHER_BRICKS),
    RED_NETHER_BRICKS_DIAGONAL_BRICKS("Diagonal Nether Bricks", () -> Blocks.RED_NETHER_BRICKS, false, RED_NETHER_BRICKS),
    ...
    RED_NETHER_BRICKS_ROTATED_BRICKS("Rotated Nether Bricks", () -> Blocks.RED_NETHER_BRICKS, false, RED_NETHER_BRICKS),
    RED_NETHER_BRICKS_SMALL_TILES("Small Red Nether Brick Tiles", () -> Blocks.RED_NETHER_BRICKS, false, RED_NETHER_BRICKS),
    RED_NETHER_BRICKS_SMOOTH("Nether Bricks Smooth", () -> Blocks.RED_NETHER_BRICKS, false, RED_NETHER_BRICKS),
    RED_NETHER_BRICKS_SQUARES("Nether Brick Squares", () -> Blocks.RED_NETHER_BRICKS, false, RED_NETHER_BRICKS),
