...
public interface RechiseledBlockBuilder {
     ...
     * @deprecated do not use this. Specify properties explicitly through {@link #properties(Supplier)}.
     */
    @Deprecated
     ...
     */
    RechiseledBlockBuilder itemGroups(ItemGroup group, ItemGroup... groups);
