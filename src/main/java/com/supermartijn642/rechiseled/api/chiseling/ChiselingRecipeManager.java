...
public interface ChiselingRecipeManager {
     ...
     */
    static void registerPlugin(Identifier identifier, ChiselingRecipePlugin plugin, int priority){
     ...
     */
    static void registerPlugin(Identifier identifier, ChiselingRecipePlugin plugin){
