...
public interface ChiselingEntryBuilder {
     ...
     */
    ChiselingEntryBuilder regularItem(ChiselingBlockShape shape, IItemProvider item, float worth);

    /**
     * Sets the regular item for the given shape with a worth of {@code 1}.
     */
    ChiselingEntryBuilder regularItem(ChiselingBlockShape shape, IItemProvider item);
     ...
     * @param worth number of items that this item is worth relative to other items in the recipe
     */
    ChiselingEntryBuilder connectingItem(ChiselingBlockShape shape, IItemProvider item, float worth);

    /**
     * Sets the connecting item for the given shape with a worth of {@code 1}.
     */
    ChiselingEntryBuilder connectingItem(ChiselingBlockShape shape, IItemProvider item);
     ...
     * @param worth number of items that this item is worth relative to other items in the recipe
     */
    ChiselingEntryBuilder regularBlock(IItemProvider item, float worth);

    /**
     * Sets the regular block with a worth of {@code 1}.
     */
    ChiselingEntryBuilder regularBlock(IItemProvider item);
     ...
     * @param worth number of items that this item is worth relative to other items in the recipe
     */
    ChiselingEntryBuilder regularStairs(IItemProvider item, float worth);

    /**
     * Sets the regular stairs with a worth of {@code 1}.
     */
    ChiselingEntryBuilder regularStairs(IItemProvider item);
     ...
     * @param worth number of items that this item is worth relative to other items in the recipe
     */
    ChiselingEntryBuilder regularSlab(IItemProvider item, float worth);

    /**
     * Sets the regular slab with a worth of {@code 0.5f}.
     */
    ChiselingEntryBuilder regularSlab(IItemProvider item);
     ...
     * @param worth number of items that this item is worth relative to other items in the recipe
     */
    ChiselingEntryBuilder connectingBlock(IItemProvider item, float worth);

    /**
     * Sets the connecting block with a worth of {@code 1}.
     */
    ChiselingEntryBuilder connectingBlock(IItemProvider item);
     ...
     * @param worth number of items that this item is worth relative to other items in the recipe
     */
    ChiselingEntryBuilder connectingStairs(IItemProvider item, float worth);

    /**
     * Sets the connecting stairs with a worth of {@code 1}.
     */
    ChiselingEntryBuilder connectingStairs(IItemProvider item);
     ...
     * @param worth number of items that this item is worth relative to other items in the recipe
     */
    ChiselingEntryBuilder connectingSlab(IItemProvider item, float worth);

    /**
     * Sets the connecting slab with a worth of {@code 0.5f}.
     */
    ChiselingEntryBuilder connectingSlab(IItemProvider item);
}
